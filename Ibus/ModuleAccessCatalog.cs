...
public static class ModuleAccessCatalog
{
    ...
    [
        ...
        new(Settings),
        new(DailyOperations),
        new(ClippingVolume, LegacyPermissionKey: DailyOperations, SupportsDelete: true),
        new(GreenSpeed, LegacyPermissionKey: DailyOperations, SupportsDelete: true),
        new(CuttingHeight, LegacyPermissionKey: DailyOperations, SupportsDelete: true),
        new(Messages),
        new(SnagList),
        new(Diagnostics),
        new(TdrMoisture, LegacyPermissionKey: Fields, SupportsDelete: true),
        new(GrassSpeciesAnalysis),
        new(Applications, IsReleased: false),
        new(Planning, IsReleased: false),
        new(CurrentWeather),
        new(WeatherAnalysis),
        new(Surfaces, SupportsDelete: true),
        new(SurfaceMapping, LegacyPermissionKey: Surfaces, SupportsDelete: true),
        new(SoilTests),
        new(WaterTests),
        new(LeafNitrate, SupportsDelete: true),
        new(Procural),
